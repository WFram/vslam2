...
// Copy Constructor
    Frame::Frame(const Frame &frame)
            : mpcpi(frame.mpcpi),
              ...
              mpGCNextractor(frame.mpGCNextractor),
    ...
    void Frame::ComputeStereoMatches() {
        ...
        //  tbb::parallel_for(
        //      tbb::blocked_range<int>(0, nRows), [&](tbb::blocked_range<int> rnRows)
        //      {
        //        for (int i = rnRows.begin(), iEnd = rnRows.end(); i != iEnd; i++)
        ...
        for (int iR = 0; iR < Nr; iR++) {
            ...
            if (kp.pt.y == 0.0 && kp.pt.x == 0.0) continue;
