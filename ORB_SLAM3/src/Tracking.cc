...
bool Tracking::TrackWithMotionModel() {
  ...
  if (mpAtlas->isImuInitialized() &&
      (mCurrentFrame.mnId > mnLastRelocFrameId + mnFramesToResetIMU) && mCurrentFrame.imuIsPreintegrated()) {
...
bool Tracking::TrackLocalMap() {
  ...
  if (!mpAtlas->isImuInitialized() || !mCurrentFrame.imuIsPreintegrated() || mCurrentFrame.mpImuPreintegratedFrame == nullptr || mCurrentFrame.mpcpi == nullptr || mCurrentFrame.mpImuPreintegrated == nullptr )
    Optimizer::PoseOptimization(&mCurrentFrame);
  else {
    if (mCurrentFrame.mnId <= mnLastRelocFrameId + mnFramesToResetIMU) {
